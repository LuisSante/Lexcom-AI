      ...
      <div className="max-w-sm grid gap-6 lg:grid-cols-3 items-start lg:max-w-none">
        ...
        <PricingTab
          ...
          features={[
            ...
            "LexIA Determination / Determina la probabilidad de éxito de Productos con LexIA",
            "LexVid Pro / Guiones de videos  Estructurados para tu productot",
            "LexCopy Pro / Copys para anuncios en FB",
        ...
        <PricingTab
          ...
          planDescription="Perfecto para Empresas y emprendedores que quieran usar la tegnologia mas rapida de lexcom y acelerar sus procesos en su ecommerce y determinar la probabilidad de exito de si realmente un producto sera escalable o no  asi teniendo un ecommerce exitoso"
          features={[
            "Busqueda Ilimitadas de nombres de productos",
            "LexIA Determination / Determina la probabilidad de éxito de Productos con LexIA",
